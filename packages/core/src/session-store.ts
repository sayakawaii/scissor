...
import type { ApprovalPolicy, Message, ProviderId, Scratchpad, TodoItem } from "./types.js";
...
export interface SessionData {
  ...
  /** Structured task list, restored on resume so a checklist survives restarts. */
  todos?: TodoItem[];
}
